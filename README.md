...
```json
{
  "name"      : "Ritika Sancheti",
  "role"      : "Software Development Co-op @ Sheridan College",
  "focus"     : ["Backend Engineering", "REST APIs", "System Design"],
  "building"  : "VibeNewZ — sentiment-aware news platform",
  "stack"     : ["Java", "Spring Boot", "Node.js", "Express"],
  "philosophy": "Obsessed with the systems nobody sees but everyone depends on."
}
```
...
> *"Obsessed with the systems nobody sees but everyone depends on."*

📬 Open to **internship & co-op opportunities** in Backend Engineering, API Design, or Full-Stack Development.
Let's build something solid — reach out on [LinkedIn](https://www.linkedin.com/in/ritikasancheti30/).

---

<div align="center">
<sub>⚡ Currently building VibeNewZ · Brampton, ON · Sheridan College</sub>
</div>
